...
st_ids = [student['id'] for student in my_dict['students']]
print(f"Studentebis ID: {st_ids}")

selected_id = int(input("airchiet studentis ID: "))


st_name = "mocemuli ID-it studenti ar moidzebna"
st_age = ""
st_grade = ""
...
print(f"ID: {selected_id}, name: {st_name}, age: {st_age}")

for subject in my_dict['subjects']:
    sb_name = subject['name']
    st_grade = subject['grades'].get(str(selected_id), "Not found!")
    print(f"subject: {sb_name}, grade: {st_grade}")
